...
function addExportDirectives(operation, rawVariableValues) {
  ...
  for (var _i4 = 0; _i4 < variableDefinitions.length; _i4++) {
    ...
    if (exports[_v] !== undefined) {
      if (!isScalarType(_v)) {
        errors.push(new GraphQLError("Exported variable \"".concat(_v, "\" is not a scalar type")));
      }
      ...
      if (rawVariableValues !== null && rawVariableValues[_v] !== undefined) {
        errors.push(new GraphQLError("Exported variable \"".concat(_v, "\" has already been asssigned a value")));
      }
    }
  }
  ...
  if (!isEmpty(exports)) {
    for (var _v2 in exports) {
      errors.push(new GraphQLError("@export directive used for undeclared variable \"".concat(_v2, "\"")));
    }
  }
      ...
      for (var _i8 = 0, _selection$directives2 = selection.directives; _i8 < _selection$directives2.length; _i8++) {
        ...
        if (directive.name.value === 'export') {
          ...
          if (exports[_v3] !== undefined) {
            errors.push(new GraphQLError("Exported variable \"".concat(_v3, "\" can only be exported once")));
          }
